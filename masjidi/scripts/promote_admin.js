 ...
 * الإشراف على مساجدهم، وطلباتهم تبقى `pending` إلى الأبد لأن اعتمادها يحتاج مشرفاً
...
async function listAdmins() {
  ...
  if (admins.length === 0) {
    console.log('لا مشرف على هذا الخادم — طلبات الإشراف على المساجد لن تُعتمد.');
    return;
  }
...
async function main() {
  ...
  console.log(demote
    ...
    : `✓ «${username}» صار مشرفاً — يستطيع اعتماد طلبات الإشراف والشركات.`);
}
