 ...
 * فبدونه تتراكم طلبات الإشراف بلا اعتماد. **فأوّلُ ما تُري المنصّةُ أوّلَ
...
export const ROLES = {
  /*
   * **قائمٌ على مسجد، لا إمامٌ بالضرورة.**
   *
   * التسجيل على المسجد يلزمه هذا الدور، وصفتُه الدقيقة تُختار بعده
   * (`CAPACITIES`: إمامٌ أو وكيلٌ أو مساعد). وكان اسمُه «إمام مسجد» — فوكيلُ
   * المسجد ومساعدُ الإمام **يُجبَران أن يعلنا إمامةً ليست لهما**، وقِيس في
   * متصفّح: «الصفة: إمام مسجد» في حسابه، و«سالم الوكيل · إمام مسجد» في ترويسة
   * كلّ شاشة. وهو الكذبُ نفسه الذي وُضعت `CAPACITIES` لتمنعه — أسبقُ منه وأظهر.
   */
  imam: 'قائم على مسجد',
  volunteer: 'متطوّع',
  donor: 'متبرّع',
...
export const STATUS_LABEL = {
  ...
  pending_imam_approval: 'بانتظار المعاينة والاعتماد',
  completed: 'منجَز',
  cancelled: 'ملغى',
};
...
export const AUDIT_LABEL = {
  ...
  request_completed: 'اعتُمد العمل',
  location_learned: 'سُجّل موقع المسجد على الخريطة',
  location_corrected: 'صُوّب موقع المسجد على الخريطة',
  request_cancelled: 'أُلغي الطلب',
  claim_reviewed: 'روجع تسجيل المسجد',
  mosque_transferred: 'نُقل الإشراف على المسجد',
...
export const ACTOR_LABEL = {
  imam: 'القائم على المسجد', volunteer: 'متطوّع', contractor: 'شركة',
...
/** صفة مقدّم طلب الإشراف — الوكيل يتولّى شؤون المسجد كالإمام في كثير منها. */
...
/**
 * طلب الإشراف على مسجد — ومعه تأكيد الموقع.
 *
