...
- **مواقع المساجد المجهولة لا تنتظر أئمّتها.** `scripts/resolve_locations.js`
  ...
  ولا مزاحم. **وترتيب المصادر عند التعارض: الوزارة، ثم من وقف عند المسجد، ثم
  OpenStreetMap.** وترخيص ODbL **يشترط ذكر المصدر**، فالنسبة معروضةٌ في شاشة
  «حسابي» ويحرسها اختبار متصفّح.
