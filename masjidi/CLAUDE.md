...
3. `node scripts/seed_mosques.js --limit 100` للتجربة، ثم **راقب عدّاد الطلبات**
   قبل الاستيراد الكامل (انظر كلفة الاستيراد في `docs/REVIEW.md`)، ثم الكامل.
   و`--verify` يفحص التكرار بلا كتابة.
