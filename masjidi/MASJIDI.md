...
| الاختبارات | ✅ 357 حالة على بديل Parse (`npm test`) + 185 اختبار تكامل على `parse-server` حقيقي فوق PostgreSQL ببيانات وزارة حقيقية (`npm run test:integration`) + 31 حالة في متصفّح حقيقي (`npm run test:e2e`) |
