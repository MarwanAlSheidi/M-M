...
| الاختبارات | ✅ 377 حالة على بديل Parse (`npm test`) + 222 اختبار تكامل على `parse-server` حقيقي فوق PostgreSQL ببيانات وزارة حقيقية (`npm run test:integration`) + 41 حالة في متصفّح حقيقي (`npm run test:e2e`) |
