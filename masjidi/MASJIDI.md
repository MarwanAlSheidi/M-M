...
| الاختبارات | ✅ 312 حالة على بديل Parse (`npm test`) + 146 اختبار تكامل على `parse-server` حقيقي فوق PostgreSQL ببيانات وزارة حقيقية (`npm run test:integration`) + 28 حالة في متصفّح حقيقي (`npm run test:e2e`) |
