...
| الاختبارات | ✅ 329 حالة على بديل Parse (`npm test`) + 171 اختبار تكامل على `parse-server` حقيقي فوق PostgreSQL ببيانات وزارة حقيقية (`npm run test:integration`) + 29 حالة في متصفّح حقيقي (`npm run test:e2e`) |
