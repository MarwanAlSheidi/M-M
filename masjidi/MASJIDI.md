...
| الاختبارات | ✅ 364 حالة على بديل Parse (`npm test`) + 207 اختبار تكامل على `parse-server` حقيقي فوق PostgreSQL ببيانات وزارة حقيقية (`npm run test:integration`) + 31 حالة في متصفّح حقيقي (`npm run test:e2e`) |
