...
| الاختبارات | ✅ 384 حالة على بديل Parse (`npm test`) + 238 اختبار تكامل على `parse-server` حقيقي فوق PostgreSQL ببيانات وزارة حقيقية (`npm run test:integration`) + 45 حالة في متصفّح حقيقي (`npm run test:e2e`) |
