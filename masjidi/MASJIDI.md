...
| الاختبارات | ✅ 396 حالة على بديل Parse (`npm test`) + 254 اختبار تكامل على `parse-server` حقيقي فوق PostgreSQL ببيانات وزارة حقيقية (`npm run test:integration`) + 50 حالة في متصفّح حقيقي (`npm run test:e2e`) |
