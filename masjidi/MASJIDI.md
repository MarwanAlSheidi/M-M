...
| الاختبارات | ✅ 397 حالة على بديل Parse (`npm test`) + 261 اختبار تكامل على `parse-server` حقيقي فوق PostgreSQL ببيانات وزارة حقيقية (`npm run test:integration`) + 55 حالة في متصفّح حقيقي (`npm run test:e2e`) |
